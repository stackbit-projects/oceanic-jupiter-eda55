...
1. Get "stackbit-deploy (Read+Write)" API token from your [Sanity management console](https://manage.sanity.io/projects/hq7ocjsg/settings/api)
...
1. Run the following command to fetch the content from Sanity:
        ...
        npx @stackbit/sanity-pull --ssg gatsby --sanity-project-id hq7ocjsg --sanity-token $SANITY_ACCESS_TOKEN
...
To start editing your site, you can use the Sanity interface at https://oceanic-jupiter-eda55.sanity.studio/.
...
Generated at `2021-05-14T20:17:10.779Z` by Stackbit version `0.3.52`.